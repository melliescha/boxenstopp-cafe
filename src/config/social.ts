export const facebookEnabled = true;

export const socialLinks = {
  instagram: "https://www.instagram.com/bistro.boxenstopp/",
  facebook: "https://www.facebook.com/people/Bistro-Boxenstopp/61582234436103/",
  tripadvisor:
