...
export const menuProducts: MenuProduct[] = [
  ...
  },
  {
    ...
    price: "6,20 €",
    description: "Mit Speck, Gouda, Raclettekäse und Lauch in Béchamel-Sauerrahmsauce",
    category: "Herzhaft & Ofenfrisch",
    allergens: "A,G",
    origin: perplexOrigin,
    composition: "43% Baguette, 19% Béchamel-Sauerrahmsoße, 16% Speck (Österreich), 11% Gouda (Deutschland), 5% Lauch, 5% Raclettekäse (50% Fett i. Tr.)",
    ingredients: "Weizenmehl, Trinkwasser, Schweinebauch, Käse, Sauerrahm, Sahne, Lauch, Milch, Schnittlauch, Jodsalz (Speisesalz, Kaliumjodat), Hefe, Butter, Knoblauch, Pfeffer, Gewürze, Konservierungsstoff (Natriumnitrit), Zucker, Tomatenpulver, Gewürzextrakt, geräuchertes Meersalz, Stabilisator (Diphosphate), Antioxidationsmittel (Ascorbinsäure), Rauch.",
    additives: [
    ...
    gmoFree: true,
    nutrition: [
      { label: "Brennwert", value: "1.195 kJ / 286 kcal" },
      { label: "Fett", value: "16,0 g" },
      { label: "davon gesättigte Fettsäuren", value: "8,3 g", indent: true },
      { label: "Kohlenhydrate", value: "24,0 g" },
      { label: "davon Zucker", value: "1,0 g", indent: true },
      { label: "Ballaststoffe", value: "1,5 g" },
      { label: "Eiweiß", value: "10,8 g" },
      { label: "Salz", value: "1,75 g" },
    ],
  },
  {
    id: "pikant-baguette",
    name: "Gourmet Baguette Pikant",
    price: "6,20 €",
    description: "Mit Salami, Speck, gegrillter Paprika und roten Zwiebeln",
    category: "Herzhaft & Ofenfrisch",
    allergens: "A,G",
    badge: "🌶 Pikant",
    origin: perplexOrigin,
    composition: "43% Baguette, 19% Béchamel-Sauerrahmsoße, 16% Gouda (Deutschland), 5% Salami (Österreich), 5% Speck (Österreich), 4% Paprika gegrillt, 4% rote Zwiebeln",
    ingredients: "Weizenmehl, Trinkwasser, Gouda, Tomaten, Paprika, Sauerrahm, Schweinebauch, Sahne, Zwiebeln, Schweinefleisch, Rindfleisch, Speck, Hefe, Butter, Petersilie, jodiertes Speisesalz (Speisesalz, Kaliumjodat), Oregano, Sonnenblumenöl, Knoblauch, Rosmarin, Gewürze, Pfeffer, Konservierungsstoff (Natriumnitrit), Chili, Zucker, Aromen, geräuchertes Meersalz, Antioxidationsmittel (Ascorbinsäure, Natriumascorbat, Rosmarinextrakt), Gewürzextrakt, Tomatenpulver, Rote Bete-Saftkonzentrat, Dextrose, Stabilisator (Diphosphate), Rauch.",
    additives: [
      { code: "2", name: "mit Konservierungsstoff (Natriumnitrit)" },
      { code: "3", name: "mit Antioxidationsmittel (Ascorbinsäure, Natriumascorbat)" },
      { code: "8", name: "mit Phosphat (Diphosphate)" },
    ],
    traceWarning: "Kann Spuren von Fisch und Sesamsamen enthalten.",
    gmoFree: true,
    nutrition: [
      { label: "Brennwert", value: "1.037 kJ / 248 kcal" },
      { label: "Fett", value: "11,4 g" },
      { label: "davon gesättigte Fettsäuren", value: "6,2 g", indent: true },
      { label: "Kohlenhydrate", value: "24,5 g" },
      { label: "davon Zucker", value: "1,3 g", indent: true },
      { label: "Ballaststoffe", value: "1,7 g" },
      { label: "Eiweiß", value: "10,9 g" },
      { label: "Salz", value: "1,55 g" },
    ],
  },
