...
const NotFound = () => {
  ...
  return (
    <Layout>
      <SEO title="Seite nicht gefunden (404) | Bistro Boxenstopp" description="Diese Seite existiert nicht. Kehren Sie zur Startseite des Bistro Boxenstopp in Hergatz zurück." path="/404" noindex />
