...
const About = () => {
  ...
  return (
    <Layout>
      <SEO title="Über uns | Bistro Boxenstopp Hergatz" description="Hinter dem Bistro Boxenstopp im Westallgäu steht die Inhaberfamilie: bodenständig, ehrlich, mit Leidenschaft für gute Küche und Gemeinschaft." path="/ueber-uns" image="/og/ueber-uns.jpg" />
      {/* Hero */}
