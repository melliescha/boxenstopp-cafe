...
const Menu = () => {
  ...
  return (
    <Layout>
      <SEO title="Speisekarte, Bistro Boxenstopp Hergatz" description="Unsere Karte: Flammkuchen, Pizza-Snacks, Brote, Barista-Kaffee, Matcha, Proteinshakes und der berühmte Boxenstopp-Spezial mit Kollagen." path="/speisekarte" image="/og/speisekarte.jpg" imageAlt="Speisekarte des Bistro Boxenstopp: Flammkuchen, Kaffee und Shakes" jsonLd={menuPageSchema} />
